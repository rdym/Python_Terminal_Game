...
print(ascii_banner)
print_line("Welcome to The Cave! You have fallen into a cave in a remote location and must find your way out. You have a limited amount of time to escape before you run out of supplies. Good luck!")
print_line("You will be able to move around the cave by typing 'go' and then the direction you want to go in. For example, 'go north' or 'go south'.")
...
#print_line("Press enter to begin.")
#input()
os.system('cls')
...
sleep(0.5)
print_line("You wake up in a dim cave. You can't remember how you got here or where you are. You can't see anything, but you can feel something in your pocket.")
print_line("You take the item out of your pocket and feel it. It's a torch! You can use this to see in the dark. You light the torch and look around.")
...
print_line("You can see a tunnel leading north, a tunnel leading south, a small tunnel leading east, and a small lake to the west.")
